...
if __name__ == '__main__':
    ...
    "src/backtest/implementations/__init__.py": """
""",

    "src/backtest/implementations/event_handler.py": """from src.core.strategy.event_handler import BaseEventHandler
...
class BacktestExitSignalGenerator(BaseExitSignalGenerator):
    ...
    "src/backtest/implementations/order_manager.py": """import backtrader as bt
...
class BacktestOrderManager(BaseOrderManager):
    ...
    "src/backtest/implementations/strategy_notifier.py": """from src.core.strategy.strategy_notifier import BaseStrategyNotifier
...
class BacktestStrategyNotifier(BaseStrategyNotifier):
    ...
    "src/backtest/strategy.py": """from src.core.strategy.base import BaseStrategy
