...
project_files = {
    ...
    "src/core/indicators.py": """import backtrader as bt
import collections
...
""",
    ...
    "src/core/util/kelly_criterion.py": """# src/core/util/kelly_criterion.py (新規追加)
import numpy as np
import pandas as pd
import logging
...
class BaseStrategy(bt.Strategy):
    ...
    "src/core/strategy/strategy_initializer.py": """import backtrader as bt
import inspect
import logging
